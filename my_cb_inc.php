...
<html lang="en">
  ...
  <head>
    ...
    <title>My Cashback Income</title>
    ...
    <main class="app-content">
      ...
      <div class="app-title">
        ...
        <div>
          ...
          <h1><i class="fa fa-edit"></i>My Cashback Income</h1>
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item">My Cashback Income</li>
...
$sql="select * from daily_income where inc_lvl=0 and user_id=".$_SESSION['user_id'];
