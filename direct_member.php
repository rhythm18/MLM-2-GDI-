    ...
    <main class="app-content">
      ...
      <div class="app-title">
        ...
        <div>
          ...
          <h1><i class="fa fa-edit"></i> Direct Members</h1>
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item">Direct Members</li>
...
$sql="select * from users where sponsor_id=".$spn_id;
...
$sql="select pay_status from users where member_id=".$row['member_id'];
	$status=ReturnAnyValue($conn,$sql);

	if($status==0) $strStatus="Free";
