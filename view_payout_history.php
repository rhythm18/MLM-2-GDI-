    ...
    <main class="app-content">
      ...
      <div class="app-title">
        ...
        <div>
          ...
          <h1><i class="fa fa-edit"></i>My Payout History</h1>

          <p>My Payout History</p>
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item">My Payout History</li>
...
$sql="select * from payout where user_id=".$_SESSION['user_id'];
