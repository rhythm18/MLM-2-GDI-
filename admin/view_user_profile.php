	 ...
	 <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="mng_user.php">Manage Users</a></li>
        </ul>
      </div>
    <!-- display mesage  -->
...
$sql="select * from user_profile where user_id=".$_GET['userID'];  
...
{	
  ...
  echo "<br>Pin Code: ".$row['pincode'];
  echo "<br>Company Name: ".$row['company_name'];
  echo "<br>Office Address: ".$row['office_addr'];
  echo "<br>Job Type: ".$row['job_type'];
