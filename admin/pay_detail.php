...
<html lang="en">
  ...
  <head>
    ...
    <title>GDI - Joining Payments</title>
    ...
    <main class="app-content">
      ...
      <div class="app-title">
        ...
        <div>
          ...
          <h1><i class="fa fa-edit"></i>Joining Payments</h1>
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item">Joining Payment Detail</li>
...
//$sql="select * from kyc_detail ORDER BY `kyc_detail`.`kyc_id` DESC";
  ...
  $sql="select p.*,u.name,u.member_id from user_payment p, users u where p.user_id=u.user_id order by `pay_id` DESC ";
