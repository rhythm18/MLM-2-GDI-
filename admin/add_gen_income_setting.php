...
<html lang="en">
  <head>
    ...
    <title>Add Generation Income</title>
    <meta charset="utf-8">
...
?></a>
	...
	?>
     <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>Add Generation Income Setting</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Add Generation Income Setting</li>
        </ul>
      </div>
      <div class="row">
       <div class="col-md-12">
...
$sql="insert into gen_income_setting(lvl_number,lvl_income,update_date) values('$lvl_number','$lvl_income','$udate')";
  ...
  if(mysqli_query($conn,$sql))
  {
   ...
   echo "<b>New Generation Income Info Created !!</b>";
