...
<html lang="en">
  ...
  <head>
    ...
    <title>Manage Level Income Settings</title>
    ...
    <main class="app-content">
      ...
      <div class="app-title">
        ...
        <div>
          ...
          <h1><i class="fa fa-edit"></i >Manage Level Income Settings</h1>
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item">Manage Level Income Settings</li>

          <li class="breadcrumb-item"><a href="add_singleleg_setting.php">Add Level Income Setting</a></li>
...

{
  ...
  //echo "<td>$i</td>";
    ...
    echo "<td>"."<a href=edit_singlelegsetting.php?lvlNO=".$row['lvl_number'].">Edit</a></td>";
  ...
  if($status==0) $strStatus="<a href=activate_singlelegsetting.php?lvlNO=".$row['lvl_number'].">Activate</a>";

  if($status==1) $strStatus="<a href=de_activate_singlelegsetting.php?lvlNO=".$row['lvl_number'].">Deactivate</a>";
