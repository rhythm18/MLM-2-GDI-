      ...
      $row = mysqli_fetch_array($rs);
          ...
          if($cnt>0)

              {
                ...
                $sql="update admin set last_activity =now(), login_ip='$ip' where admin_id=".$_SESSION['admin_id'];
      ...
      <div class="login-box">
        <form class="login-form" action="" method="post">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" placeholder="" autofocus name="email">
          </div>
          <div class="form-group">
