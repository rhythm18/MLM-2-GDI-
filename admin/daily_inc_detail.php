...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>Daily Income Detail</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Daily Income Detail</li>
        </ul>
      </div>
    <!-- display mesage  -->
...
//$sql="select * from kyc_detail ORDER BY `kyc_detail`.`kyc_id` DESC";
  ...
  $sql="select d.*,u.name,u.member_id from daily_income d, users u where d.user_id=u.user_id order by `inc_id` DESC ";
